...
CREATE TABLE IF NOT EXISTS items (
    ...
    map_x           FLOAT NULL,
    map_y           FLOAT NULL,
    location_desc   VARCHAR(300) NULL,
    created_at      DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at      DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (house_id) REFERENCES houses(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS iot_devices (
    ...
    smart_things_device_id     VARCHAR(200) NULL,
    lg_thinq_device_id         VARCHAR(200) NULL,
    hue_light_id               VARCHAR(50) NULL,
    smart_things_capabilities  TEXT NULL,
    platform     ENUM('SMARTTHINGS', 'GOOGLE_HOME', 'APPLE_HOME', 'TUYA', 'LG_THINQ', 'PHILIPS_HUE', 'OTHER') DEFAULT 'OTHER',
